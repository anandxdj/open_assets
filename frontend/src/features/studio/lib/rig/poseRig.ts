...
import { bipedRig } from '@/features/studio/lib/rig/biped'
import { blobRig } from '@/features/studio/lib/rig/blob'
import { flyerRig } from '@/features/studio/lib/rig/flyer'
import { quadrupedRig } from '@/features/studio/lib/rig/quadruped'
import { serpentRig } from '@/features/studio/lib/rig/serpent'

// Re-export shared types/helpers so existing importers keep working.
export type { SubjectBounds, MannequinColors, BodyPlanId } from '@/features/studio/lib/rig/rigCore'
export { measureSubjectBounds, DEFAULT_COLORS } from '@/features/studio/lib/rig/rigCore'
