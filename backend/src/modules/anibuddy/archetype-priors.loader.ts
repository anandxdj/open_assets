...
// The semantics / rig stages will call this; nothing here builds a skeleton.

import { existsSync, readFileSync } from 'node:fs';
import { dirname, join, resolve } from 'node:path';
import { fileURLToPath } from 'node:url';
import type { Archetype, DeformerKind, JointRole, PartRole } from './dto/rig-document.generated';
import { ARCHETYPE_VALUES, DEFORMER_KIND_VALUES } from './dto/rig-document.generated';
